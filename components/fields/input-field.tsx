        ...
        render={({ field }) => {
          ...
          const assignRefs = (el: HTMLInputElement | null) => {
            ...
            if (typeof fieldRef === "function") fieldRef(el);
              ...
              fieldRef &&
              "current" in
                (fieldRef as React.MutableRefObject<HTMLInputElement | null>)
            ) {
              (
                fieldRef as React.MutableRefObject<HTMLInputElement | null>
              ).current = el;
            ...
            <FormItem className={className}>
              ...
              <FormControl>
                {isFile ? (
                  ...
                  <div className="relative flex items-center gap-2 overflow-hidden rounded-md dark:bg-transparent">
                    <Input
                      id={inputId}
                      type={effectiveType}
  ...
  return (
    <div className={className}>
      ...
      {isFile ? (
        ...
        <div className="relative mt-1 flex items-center gap-2 overflow-hidden rounded-md bg-light dark:bg-transparent">
          <Input
            id={inputId}
            type={effectiveType}
            placeholder={placeholder}
